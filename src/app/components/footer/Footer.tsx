    ...
    <footer className="bg-[var(--color-marrom-claro)] text-white">
      <div className="container mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="#contact" className="text-white/80 hover:text-white transition-colors font-light text-sm">
                  Contato
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="mt-6 flex gap-4">
              <a 
                href="https://instagram.com/dra.gabryellaklein" 
                target="_blank" 
              ...
              <a 
                href="https://wa.me/5551998902287" 
                target="_blank" 
                rel="noopener noreferrer"
                className="w-10 h-10 bg-white/10 hover:bg-white/20 rounded-full flex items-center justify-center transition-colors"
                aria-label="WhatsApp"
        ...
        <div className="pt-8 border-t border-white/20">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-white/70 font-light">
            <p>
              © {currentYear} Dra. Gabryella Klein - Biomédica Esteta. Todos os direitos reservados.
            </p>
